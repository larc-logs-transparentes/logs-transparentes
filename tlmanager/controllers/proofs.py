...
from controllers.database import db_get_all_consistency_proof, db_get_global_tree_root, db_get_local_tree_root
...
def get_data_proof(tree_name, data=None, index=None):
    ...
    if local_proof['status'] == 'error':
        return local_proof
    local_root_object = db_get_local_tree_root(tree_name)
