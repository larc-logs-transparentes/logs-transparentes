...
""" Basic proofs """
@router.get('/inclusion-proof', name="/inclusion-proof", description=descriptions['inclusion_proof'], responses={200: {'model': BasicProof}})
...
@router.get('/global-tree-consistency-proof', name="/global-tree-consistency-proof", description=descriptions['global_tree_consistency_proof'], responses={200: {'model': BasicProof}})
...
""" High level proofs """
@router.get('/data-proof', name="/data-proof", description=descriptions['data_proof'], responses={200: {'model': DataProof}})
...
@router.get('/all-consistency-proof', name="/all-consistency-proof", description=descriptions['all_consistency_proof'], responses={200: {'model': AllConsistencyProof}})
