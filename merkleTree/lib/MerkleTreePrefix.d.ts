 ...
 */
export declare class MerkleTreePrefix extends Base {
     ...
     *```
     */
    addLeaf(leaf: TLeafPref, shouldHash?: boolean): void;
    /**
     * addLeaves
     ...
     *```
     */
    addLeaves(leaves: TLeafPref[], shouldHash?: boolean): void;
    /**
     * getLeaves
