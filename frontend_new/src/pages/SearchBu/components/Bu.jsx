  ...
  return (
    <div className='w-[892px] h-[403px] border-2 border-blue-light rounded-2xl '> 
        <div className='mt-[34px] ml-[24px]'>
            <div className='flex'>
                <h1 className='text-blue text-2xl font-bold '>Boletim de Urna</h1>
                <button class="rounded-full bg-yellow px-2 h-[37px] w-[194px]   ml-[256px] font-bold">Enviar para o Monitor</button>
                <button class="rounded-full bg-yellow px-2 h-[37px] w-[102px]  ml-[16px] font-bold">Baixar Bu</button>
