      ...
      <div className='relative bg-white rounded-2xl shadow-xl flex flex-col p-8 md2:w-[714px] md2:h-[469px]'>
        ...
        <div className='flex align-items-center items-center place-content-center gap-[2%]'>
          <div className='flex-col flex'>Manual
            <div onClick={toggleModal} className='cursor-pointer flex flex-col items-center border-blue-light hover:bg-blue-light border-2 p-2 rounded-2xl text-center text-black md2:h-[242px] md2:w-[320px]'>
              <button className="">
          ...
          <div className='flex-col flex'>Automático
            <div className='cursor-pointer flex flex-col items-center border-blue-light hover:bg-blue-light border-2 p-2 rounded-2xl text-center text-black md2:h-[242px] md2:w-[320px]'>
              <button className="">
