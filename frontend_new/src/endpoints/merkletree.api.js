...
export function getDataProof(merkletree_leaf_index,id_eleicao){
    return new Promise(function (resolve, reject){
        axios.get(`${bu_api_url}/tree/data-proof?tree_name=bu_tree_election_${id_eleicao}&index=${merkletree_leaf_index}`)
        .then((res) => {
            resolve((res.data));
        },
        (err) => {
