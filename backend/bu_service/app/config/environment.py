...
if '${METADATA_NAME}' not in METADATA_TREE_NAME_TEMPLATE:
    raise Exception("METADATA_TREE_NAME_TEMPLATE must contain ${METADATA_NAME}")

if '${ELECTION_ID}' not in METADATA_TREE_NAME_TEMPLATE:
    raise Exception("METADATA_TREE_NAME_TEMPLATE must contain ${ELECTION_ID}")

logging.debug("BU_TREE_NAME_TEMPLATE: %s", BU_TREE_NAME_TEMPLATE)
logging.debug("METADATA_TREE_NAME_TEMPLATE: %s", METADATA_TREE_NAME_TEMPLATE)
