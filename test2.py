...
TRUSTED_SOURCE_DATA = f'http://localhost:8080/bu/download?id={BU_ID}'
...
if __name__ == '__main__':
    ...
    for key in bu['merkletree_info']:  # each election tree
        ...
        file = requests.get(TRUSTED_SOURCE_DATA)
        encoded_str = base64.b64encode(file.content).decode('utf-8')

        # verifying proof
        result = verify_data_entry(proof, trusted_root, base64.b64decode(encoded_str))
